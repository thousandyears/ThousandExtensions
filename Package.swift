...
let package = Package(
    ...
    targets: [
        .target(name: "ThousandExtensions", dependencies: ["FoundationExtensions", "SKExtensions", "Periscope", "CombineExtensions"]),
        .target(name: "SKExtensions", dependencies: ["FoundationExtensions"]),
        .target(name: "FoundationExtensions", dependencies: ["CGExtensions"]),
        .target(name: "CombineExtensions", dependencies: ["FoundationExtensions", "Periscope"]),
